package com.rest.crud.REST_API.controller;
...
import com.rest.crud.REST_API.repository.UserRepository;
...
public class UserController {
    ...
    public ResponseEntity<User> createUser(@RequestBody User user) {
        try {
            User _user = userRepository.save(new User (user.getName(), user.getDescription(), false));
